...
class ReusableMovieCard extends StatelessWidget {
  ...
  const ReusableMovieCard(
      {super.key, required this.movie, required this.isPaused});

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: ()=> Navigator.pushNamed(context, WatchMovieView.kWatchMovieView,
          arguments: movie)
        ,
      child: Container(
        height: 200,
  ...
  Widget _buildPlayButton() => isPaused
      ? Align(
          alignment: Alignment.center,
          child: ClipRRect(
  ...
  Widget _buildProgressSection() => isPaused
      ? Align(
          alignment: Alignment.bottomCenter,
          child: Column(
